...
export function WhatsAppFloat() {
  return (
    ...
    >
      ...
      <span className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-primary shadow-glow-primary transition-bounce group-hover:scale-110">
