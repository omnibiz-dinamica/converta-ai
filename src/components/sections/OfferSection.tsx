      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 font-display text-3xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl">
            Implementamos o seu atendimento inteligente em{" "}
            <span className="text-gradient-accent">poucos dias</span>
          </h2>
          <p className="mt-5 text-lg text-muted-foreground">
            Criamos um sistema personalizado para a sua empresa, integrado aos seus canais, pronto
            para atender, qualificar e encaminhar oportunidades.
          </p>
        </div>
